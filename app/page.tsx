  ...
  return (
    <main className="min-h-screen bg-white" style={{ fontFamily: 'var(--font-source-sans), sans-serif' }}>
      ...
      <nav className="flex items-center justify-between px-10 py-4 bg-white border-b border-gray-100 sticky top-0 z-50">
        ...
        <Image src="/images/KC-logo-with-seal.png" alt="Key Club" width={160} height={40} className="object-contain" />
          <div className="border-l border-gray-200 pl-3">
            <div className="text-sm font-semibold text-gray-900 leading-tight">Montville</div>
        ...
        <div className="flex items-center gap-8">
          ...
          <a href="#" className="text-sm text-gray-600 hover:text-blue-800 font-medium transition-colors">Events</a>
        ...
        <button className="bg-[#003366] hover:bg-blue-900 text-white text-sm px-5 py-2.5 rounded-lg font-medium transition-colors">Member Login</button>
      </nav>
      ...
      <div className="relative h-[620px] w-full overflow-hidden">
        ...
        <div className="absolute inset-0 flex flex-col justify-center px-16 max-w-4xl">
          <div className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-sm text-white/90 text-xs px-3 py-1.5 rounded-full mb-6 w-fit border border-white/20 uppercase tracking-widest">
            Montville Township High School
          </div>
          <h1 className="text-6xl font-bold text-white leading-tight mb-5" style={{ fontFamily: 'var(--font-playfair), serif' }}>
          ...
          <div className="flex gap-3">
            <button className="bg-white text-[#003366] px-7 py-3 rounded-lg text-sm font-semibold hover:bg-blue-50 transition-colors">Join Key Club</button>
            <button className="border border-white/60 text-white px-7 py-3 rounded-lg text-sm font-medium hover:bg-white/10 transition-colors">View Events</button>
          </div>
        </div>
      </div>

      {/* Stats */}
      <div className="bg-[#003366] py-12 px-8">
        <div className="max-w-5xl mx-auto grid grid-cols-3 gap-8 text-center">
          <div>
            <div className="text-5xl font-bold text-white" style={{ fontFamily: 'var(--font-playfair), serif' }}>175+</div>
            <div className="text-blue-300 text-sm mt-2 uppercase tracking-wider">Active members</div>
          </div>
          <div className="border-x border-blue-500">
            <div className="text-5xl font-bold text-white" style={{ fontFamily: 'var(--font-playfair), serif' }}>2,400+</div>
            <div className="text-blue-300 text-sm mt-2 uppercase tracking-wider">Service hours logged</div>
          </div>
          <div>
            <div className="text-5xl font-bold text-white" style={{ fontFamily: 'var(--font-playfair), serif' }}>30+</div>
            <div className="text-blue-300 text-sm mt-2 uppercase tracking-wider">Events this year</div>
          </div>
        </div>
      </div>
      ...
      <div className="px-8 py-14 bg-gray-50">
        <div className="max-w-5xl mx-auto">
          ...
          <h2 className="text-3xl font-bold text-gray-900 mb-8" style={{ fontFamily: 'var(--font-playfair), serif' }}>Making an impact</h2>
      ...
      <div className="px-8 py-16 bg-white">
        <div className="max-w-5xl mx-auto grid grid-cols-2 gap-16 items-center">
          <div>
            ...
            <h2 className="text-3xl font-bold text-gray-900 mb-5" style={{ fontFamily: 'var(--font-playfair), serif' }}>Welcome to MTHS Key Club</h2>
      ...
      <div className="px-8 py-14">
        <div className="max-w-5xl mx-auto">
          ...
          <h2 className="text-3xl font-bold text-gray-900 mb-8" style={{ fontFamily: 'var(--font-playfair), serif' }}>Upcoming events</h2>
      ...
      <div className="px-8 py-14 bg-gray-50">
        <div className="max-w-5xl mx-auto">
          ...
          <h2 className="text-3xl font-bold text-gray-900 mb-8" style={{ fontFamily: 'var(--font-playfair), serif' }}>Latest announcements</h2>
          <div className="grid grid-cols-2 gap-5">
            {[
              ...
              <div key={i} className="bg-white rounded-xl p-7 border border-gray-100 hover:shadow-md transition-all">
      ...
      {/* Footer */}
      <footer className="bg-[#001a33] text-blue-300 px-10 py-10">
        <div className="max-w-5xl mx-auto flex justify-between items-start">
          <div>
            <Image src="/images/keyclub-wordmark.png" alt="Key Club" width={50} height={33} className="object-contain brightness-0 invert mb-3" />
