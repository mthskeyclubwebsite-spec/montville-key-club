    ...
    <main className="min-h-screen bg-white" style={{ fontFamily: 'var(--font-source-sans), sans-serif' }}>
      ...
      <nav className="flex items-center justify-between px-5 md:px-10 py-4 bg-white border-b border-gray-100 sticky top-0 z-50">
        ...
        <div className="hidden md:flex items-center gap-8">
          ...
          <a href="/follow_us" className="text-sm text-[#003366] font-semibold">Follow Us</a>
        </div>
      ...
      <div className="bg-[#003366] px-6 md:px-8 py-14 md:py-20 text-center">
        <p className="text-xs uppercase tracking-widest text-blue-300 font-semibold mb-3">Stay connected</p>
      ...
      <div className="px-5 md:px-8 py-14 md:py-20">
        <div className="max-w-2xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-5">
          ...
          <a href="https://www.instagram.com/montvillekeyclub/" target="_blank" rel="noopener noreferrer" className="group bg-white border border-gray-100 rounded-2xl p-8 flex flex-col items-center text-center hover:shadow-md hover:border-[#003366]/20 transition-all">
          ...
          <a href="https://www.tiktok.com/@mths.key.club1?_r=1&_t=ZT-94MOLvUJSc2" target="_blank" rel="noopener noreferrer" className="group bg-white border border-gray-100 rounded-2xl p-8 flex flex-col items-center text-center hover:shadow-md hover:border-[#003366]/20 transition-all">
          ...
          <a href="https://www.facebook.com/profile.php?id=61551127135454" target="_blank" rel="noopener noreferrer" className="group bg-white border border-gray-100 rounded-2xl p-8 flex flex-col items-center text-center hover:shadow-md hover:border-[#003366]/20 transition-all">
          ...
          <div className="flex gap-12">
            ...
            <div>
              ...
              <div className="flex flex-col gap-2">
                ...
                <a href="/follow_us" className="text-sm hover:text-white transition-colors">Follow Us</a>
              </div>
            </div>
          </div>
        </div>
